...
# the mother hash is using the rockets to use the keys and the values. the sibblings hash are using to identify between values. 
# State hash is just a hash variable (check the equal sign.) 
